...
#include "OnlineVoice/VoiceEngineMoonwards.h"

FOnlineVoiceMoonwards::FOnlineVoiceMoonwards(IOnlineSubsystem* InOnlineSubsystem) :
	OnlineSubsystem(InOnlineSubsystem),
	VoiceEngine(NULL)
{
}

FOnlineVoiceMoonwards::~FOnlineVoiceMoonwards()
{
	LocalTalkers.Empty();
	RemoteTalkers.Empty();
	VoiceEngine = NULL;
...
bool FOnlineVoiceMoonwards::Init()
{
	bool bSuccess = true;
...
void FOnlineVoiceMoonwards::Shutdown()
{
...
void FOnlineVoiceMoonwards::ClearVoicePackets()
{
...
void FOnlineVoiceMoonwards::Tick(float DeltaTime)
{
...
void FOnlineVoiceMoonwards::StartNetworkedVoice(uint8 LocalUserNum)
{
...
void FOnlineVoiceMoonwards::StopNetworkedVoice(uint8 LocalUserNum)
{
	// Validate the range of the entry
	if (LocalUserNum >= 0 && LocalUserNum < MaxLocalTalkers)
	{
		...
		if(LocalTalkers.Num() > LocalUserNum)
		{
...
bool FOnlineVoiceMoonwards::RegisterLocalTalker(uint32 LocalUserNum)
{
...
void FOnlineVoiceMoonwards::RegisterLocalTalkers()
{
...
bool FOnlineVoiceMoonwards::UnregisterLocalTalker(uint32 LocalUserNum)
{
...
void FOnlineVoiceMoonwards::UnregisterLocalTalkers()
{
...
bool FOnlineVoiceMoonwards::RegisterRemoteTalker(const FUniqueNetId& UniqueId)
{
	uint32 Return = ONLINE_FAIL;
	if (OnlineSubsystem)
	{
...
bool FOnlineVoiceMoonwards::UnregisterRemoteTalker(const FUniqueNetId& UniqueId)
{
	uint32 Return = ONLINE_FAIL;
	if (OnlineSubsystem)
	{
...
void FOnlineVoiceMoonwards::RemoveAllRemoteTalkers()
{
...
FRemoteTalker* FOnlineVoiceMoonwards::FindRemoteTalker(const FUniqueNetId& UniqueId)
{
	for (int32 Index = 0; Index < RemoteTalkers.Num(); Index++)
	{
...
bool FOnlineVoiceMoonwards::IsHeadsetPresent(uint32 LocalUserNum)
{
	return VoiceEngine.IsValid() && VoiceEngine->IsHeadsetPresent(LocalUserNum);
}

bool FOnlineVoiceMoonwards::IsLocalPlayerTalking(uint32 LocalUserNum)
{
	return VoiceEngine.IsValid() && VoiceEngine->IsLocalPlayerTalking(LocalUserNum);
}

bool FOnlineVoiceMoonwards::IsRemotePlayerTalking(const FUniqueNetId& UniqueId)
{
	return VoiceEngine.IsValid() && VoiceEngine->IsRemotePlayerTalking(UniqueId);
}

bool FOnlineVoiceMoonwards::IsMuted(uint32 LocalUserNum, const FUniqueNetId& UniqueId) const
{
	if (LocalUserNum >= 0 && LocalUserNum < (uint32)MaxLocalTalkers)
	{
...
bool FOnlineVoiceMoonwards::IsLocallyMuted(const FUniqueNetId& UniqueId) const
{
	int32 Index = MuteList.Find(FUniqueNetIdWrapper(UniqueId.AsShared()));
	return Index != INDEX_NONE;
}

bool FOnlineVoiceMoonwards::IsSystemWideMuted(const FUniqueNetId& UniqueId) const
{
	int32 Index = SystemMuteList.Find(FUniqueNetIdWrapper(UniqueId.AsShared()));
	return Index != INDEX_NONE;
}

bool FOnlineVoiceMoonwards::MuteRemoteTalker(uint8 LocalUserNum, const FUniqueNetId& PlayerId, bool bIsSystemWide)
{
	uint32 Return = ONLINE_FAIL;
	if (LocalUserNum >= 0 && LocalUserNum < MaxLocalTalkers )
	{
...
bool FOnlineVoiceMoonwards::UnmuteRemoteTalker(uint8 LocalUserNum, const FUniqueNetId& PlayerId, bool bIsSystemWide)
{
	uint32 Return = ONLINE_FAIL;
	if (LocalUserNum >= 0 && LocalUserNum < MaxLocalTalkers )
	{
...
void FOnlineVoiceMoonwards::ProcessMuteChangeNotification()
{
...
IVoiceEnginePtr FOnlineVoiceMoonwards::CreateVoiceEngine()
{
	return MakeShareable(new FVoiceEngineMoonwards(OnlineSubsystem));
}

void FOnlineVoiceMoonwards::UpdateMuteListForLocalTalker(int32 TalkerIndex, APlayerController* PlayerController)
{
...
TSharedPtr<FVoicePacket> FOnlineVoiceMoonwards::SerializeRemotePacket(FArchive& Ar)
{
...
TSharedPtr<FVoicePacket> FOnlineVoiceMoonwards::GetLocalPacket(uint32 LocalUserNum)
{
...
void FOnlineVoiceMoonwards::ProcessTalkingDelegates(float DeltaTime)
{
...
void FOnlineVoiceMoonwards::ProcessLocalVoicePackets()
{
	if (VoiceEngine.IsValid())
	{
...
void FOnlineVoiceMoonwards::ProcessRemoteVoicePackets()
{
...
FString FOnlineVoiceMoonwards::GetVoiceDebugState() const
{
...
Audio::FPatchOutputStrongPtr FOnlineVoiceMoonwards::GetMicrophoneOutput()
{
	if (VoiceEngine.IsValid())
	{
...
Audio::FPatchOutputStrongPtr FOnlineVoiceMoonwards::GetRemoteTalkerOutput()
{
	if (VoiceEngine.IsValid())
	{
...
float FOnlineVoiceMoonwards::GetAmplitudeOfRemoteTalker(const FUniqueNetId& PlayerId)
{
	if (VoiceEngine.IsValid())
	{
...
bool FOnlineVoiceMoonwards::PatchRemoteTalkerOutputToEndpoint(const FString& InDeviceName, bool bMuteInGameOutput /*= true*/)
{
	if (VoiceEngine.IsValid())
	{
...
bool FOnlineVoiceMoonwards::PatchLocalTalkerOutputToEndpoint(const FString& InDeviceName)
{
	if (VoiceEngine.IsValid())
	{
...
void FOnlineVoiceMoonwards::DisconnectAllEndpoints()
{
	if (VoiceEngine.IsValid())
	{
